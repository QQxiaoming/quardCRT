...
$date_timestamps = $([String]::Format("{0}", [Math]::Floor($(Get-Date).ToUniversalTime().Subtract((Get-Date "1970-01-01")).TotalSeconds)))
...
Write-Output "#define BUILD_DATE_TIMESTAMPS ""$date_timestamps"""
Write-Output "#define BUILD_DATE_TIMESTAMPS_LEN $($date_timestamps.Length)"
Write-Output ""
