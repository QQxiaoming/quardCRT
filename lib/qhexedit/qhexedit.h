...
class QHexEdit : public QAbstractScrollArea
{
    ...
    */
    ...
    /*! Property hex area color sets (setHexAreaColor()) the background
    color of hex areas. You can also read the color (hexAreaColor()).
    */
    Q_PROPERTY(QColor hexAreaColor READ hexAreaColor WRITE setHexAreaColor)
