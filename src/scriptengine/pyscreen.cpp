...
static PyObject* Screen_WaitForString(Screen* self, PyObject* args, PyObject* kwargs) {
    ...
    QString ret = PyCore::getCore()->screenWaitForString(qstrlist,timeout,bcaseInsensitive,self->matchIndex);
...
static PyObject* Screen_Send(Screen* self, PyObject* args) {
    ...
    QString qstr = QString::fromUtf8(str);
    int ret = PyCore::getCore()->screenSend(qstr,self->synchronous);
...
static PyObject* Screen_Get(Screen* self, PyObject* args) {
    ...
    QString ret = PyCore::getCore()->screenGet(row1, col1, row2, col2);
    return PyUnicode_FromString(ret.toUtf8().constData());
}
...
static PyObject* Screen_Get2(Screen* self, PyObject* args) {
    ...
    QString ret = PyCore::getCore()->screenGet2(row1, col1, row2, col2);
    return PyUnicode_FromString(ret.toUtf8().constData());
}
...
static PyObject* Screen_Shortcut(Screen* self, PyObject* args) {
    ...
    PyCore::getCore()->screenShortcut(qpath);
    Py_RETURN_NONE;
}
...
static PyObject* Screen_SendKeys(Screen* self, PyObject* args) {
    ...
    if (!PyList_Check(keylist)) {
        ...
        PyCore::getCore()->screenSendKeys(qkeylist);
    }
    Py_RETURN_NONE;
}
...
static PyObject* Screen_getCurrentColumn(Screen* self, void* closure) {
    Q_UNUSED(self);
    Q_UNUSED(closure);
    int ret = PyCore::getCore()->screenGetCurrentColumn();
    return Py_BuildValue("i", ret);
}
...
static PyObject* Screen_getCurrentRow(Screen* self, void* closure) {
    Q_UNUSED(self);
    Q_UNUSED(closure);
    int ret = PyCore::getCore()->screenGetCurrentRow();
    return Py_BuildValue("i", ret);
}
...
static PyObject* Screen_getRows(Screen* self, void* closure) {
    Q_UNUSED(self);
    Q_UNUSED(closure);
    int ret = PyCore::getCore()->screenGetRows();
    return Py_BuildValue("i", ret);
}
...
static PyObject* Screen_getColumns(Screen* self, void* closure) {
    Q_UNUSED(self);
    Q_UNUSED(closure);
    int ret = PyCore::getCore()->screenGetColumns();
    return Py_BuildValue("i", ret);
}
...
static PyObject* Screen_getSelection(Screen* self, void* closure) {
    Q_UNUSED(self);
    Q_UNUSED(closure);
    QString ret = PyCore::getCore()->screenGetSelection();
    return PyUnicode_FromString(ret.toUtf8().constData());
}
