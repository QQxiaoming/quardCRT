...
static PyObject* QuardCRT_GetActiveTab(QuardCRT* self, PyObject* args) {
    ...
    PyObject *tab = PyObject_CallObject((PyObject *)&PyTab::TabType, tabNameArg);
...
static PyObject* QuardCRT_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    ...
    if (self != NULL) {
        ...
        Py_INCREF(self->dialog);
        self->session = PyObject_CallObject((PyObject *)&PySession::SessionType, NULL);
        Py_INCREF(self->session);
        self->screen = PyObject_CallObject((PyObject *)&PyScreen::ScreenType, NULL);
        Py_INCREF(self->screen);
